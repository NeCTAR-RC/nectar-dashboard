# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2020-03-10 01:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persistent_id', models.CharField(blank=True, help_text="The user's\n                                     eduPersonTargetedId", max_length=250, null=True, unique=True)),
                ...
                ('state', models.CharField(blank=True, choices=[('new', 'new'), ('registered', 'registered'), ('created', 'created')], default='new', max_length=10, null=True)),
                ('terms_accepted_at', models.DateTimeField(blank=True, null=True)),
                ('shibboleth_attributes', models.BinaryField(blank=True, null=True)),
                ('registered_at', models.DateTimeField(blank=True, null=True)),
                ('terms_version', models.CharField(blank=True, max_length=64, null=True)),
