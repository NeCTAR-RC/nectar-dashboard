...
class IndexView(horizon_views.HorizonTemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        usage_data = usage.get_summary(
            self.request, groupby='time-1d', begin=begin, end=end, filters={}
        )
        ...
        summary_data = usage.get_summary(
            self.request, begin=begin, end=end, filters={}
        )
        if summary_data:
