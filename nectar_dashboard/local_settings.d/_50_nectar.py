...
REST_VIEW_SETS = (
    ...
    (
        'publications',
        'nectar_dashboard.rcallocation.api.allocation_extra.PublicationViewSet',  # noqa
        None,
    ),
    (
        'grants',
    ...
    (
        'ardc-projects',
        'nectar_dashboard.rcallocation.api.allocation_support.ARDCSupportViewSet',  # noqa
        None,
    ),
    (
        'approvers',
