...
class AllocationDetailView(mixins.UserPassesTestMixin, DetailView, ModelFormMixin):
    """
...
class AllocationsListView(mixins.UserPassesTestMixin, horizon_tables.DataTableView):
    """
...
class AllocationHistoryView(mixins.UserPassesTestMixin, horizon_tables.DataTableView):
    """
    A simple paginated view of the allocation requests, ordered by
    status. Later we should perhaps add sortable columns, filterable
    by status?
