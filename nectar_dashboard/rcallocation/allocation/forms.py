...
class AllocationApproveForm(d_forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'requested_allocation_home': d_forms.Select(attrs={'class': 'col-md-6'}),
    ...
    def __init__(self, **kwargs):
        ...
        self.fields['requested_allocation_home'].label = 'Requested Allocation Home'
        self.fields['requested_allocation_home'].widget.attrs['class'] = 'form-control'
        self.fields['requested_allocation_home'].widget.attrs['readonly'] = True
        self.fields['requested_allocation_home'].widget.attrs['disabled'] = True
