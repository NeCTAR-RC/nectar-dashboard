...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Quota'
        db.create_table(u'rcallocation_quota', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('allocation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quotas', to=orm['rcallocation.AllocationRequest'])),
            ('resource', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('zone', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('requested_quota', self.gf('django.db.models.fields.IntegerField')(default='0')),
            ('quota', self.gf('django.db.models.fields.IntegerField')(default='0')),
            ('units', self.gf('django.db.models.fields.CharField')(default='GB', max_length=64)),
        ))
        db.send_create_signal(u'rcallocation', ['Quota'])


    def backwards(self, orm):
        # Deleting model 'Quota'
        db.delete_table(u'rcallocation_quota')
