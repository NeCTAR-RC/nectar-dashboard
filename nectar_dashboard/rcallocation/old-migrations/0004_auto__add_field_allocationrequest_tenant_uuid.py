...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AllocationRequest.tenant_uuid'
        db.add_column('rcallocation_allocationrequest', 'tenant_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AllocationRequest.tenant_uuid'
        db.delete_column('rcallocation_allocationrequest', 'tenant_uuid')
    ...
    models = {
        'rcallocation.allocationrequest': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 3, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 3, 0, 0)'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'N'", 'max_length': '1'}),
            'submit_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 3, 0, 0)'}),
