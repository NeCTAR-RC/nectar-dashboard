...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AllocationRequest.parent_request'
        db.add_column('rcallocation_allocationrequest', 'parent_request',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rcallocation.AllocationRequest'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AllocationRequest.parent_request'
        db.delete_column('rcallocation_allocationrequest', 'parent_request_id')
    ...
    models = {
        'rcallocation.allocationrequest': {
            ...
            'parent_request': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rcallocation.AllocationRequest']", 'null': 'True', 'blank': 'True'}),
