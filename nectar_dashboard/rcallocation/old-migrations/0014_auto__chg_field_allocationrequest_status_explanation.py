...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AllocationRequest.status_explanation'
        db.alter_column(u'rcallocation_allocationrequest', 'status_explanation', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'AllocationRequest.status_explanation'
        db.alter_column(u'rcallocation_allocationrequest', 'status_explanation', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
