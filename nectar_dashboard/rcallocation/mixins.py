# Coopied from Django v1.11.11 which is the version in Bionic
#
# These mixins are not available in Django v1.8 (xenial)
#
...
class UserPassesTestMixin(AccessMixin):
    ...
    def test_func(self):
        raise NotImplementedError(
            '{0} is missing the implementation of the test_func() '
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if not user_test_result:
            return self.handle_no_permission()
        return super(UserPassesTestMixin, self).dispatch(request, *args,
                                                         **kwargs)
