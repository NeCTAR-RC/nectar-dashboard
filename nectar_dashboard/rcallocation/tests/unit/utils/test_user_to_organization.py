...
class UserToOrganizationTest(helpers.TestCase):
    ...
    def test_user_to_organization(self):
        ...
        # Invalid user names
        self.assertIsNone(utils.user_to_organization("fred"))
        self.assertIsNone(utils.user_to_organization("@a.b.c"))
        self.assertIsNone(utils.user_to_organization("fred@"))
        self.assertIsNone(utils.user_to_organization("fred@@a.b.c"))
        self.assertIsNone(utils.user_to_organization("@"))
