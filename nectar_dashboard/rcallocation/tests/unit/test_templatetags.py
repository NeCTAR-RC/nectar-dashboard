...
class PublicationExtrasTestCase(helpers.TestCase):
    ...
    def test_output_type_descr(self):
        self.assertEqual("Other",
                         publication_extras.output_type_descr(
                             output_type_choices.OTHER))
        self.assertEqual("Unspecified",
                         publication_extras.output_type_descr(
                             output_type_choices.UNSPECIFIED))
        self.assertEqual('',
                         publication_extras.output_type_descr(''))
        self.assertEqual("???",
                         publication_extras.output_type_descr('Z'))
    ...
    def test_crossref_summary(self):
        ...
        self.assertEqual("*** Not a JSON object ***",
                         publication_extras.crossref_summary('["Jason"]'))
        self.assertEqual("*** Not a JSON Crossref response ***",
                         publication_extras.crossref_summary(
                             '{"name": "Jason"}'))
        ...
        self.assertEqual("<i>Title</i>: one, "
                         "<i>Author(s)</i>: Not recorded, "
                         "<i>Publication</i>: Not recorded, "
                         "<i>Year</i>: Not recorded",
                         publication_extras.crossref_summary(
        ...
        self.assertEqual("<i>Title</i>: &lt;i&gt;one&lt;/i&gt;, "
                         "<i>Author(s)</i>: Not recorded, "
                         "<i>Publication</i>: Not recorded, "
                         "<i>Year</i>: Not recorded",
                         publication_extras.crossref_summary(
    ...
    def test_pub_summary(self):
        pub = models.Publication(output_type=output_type_choices.OTHER,
                                 doi='10.004/1234',
                                 crossref_metadata= '{"message": {"a": "b"}}')
        self.assertEqual("<i>Type</i>: Other, "
