...
def approver_setup():
    ...
    test_user = models.Approver.objects.create(name="test_user",
                                               display_name="One")
    test_user2 = models.Approver.objects.create(name="test_user2",
                                                display_name="Two")
    models.Approver.objects.create(name="test_user3", display_name="Three")
