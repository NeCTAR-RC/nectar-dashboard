...
class Publication(models.Model):
    ...
    output_type = models.ChoiceField(
    ...
    # Confirmed == True means that someone has confirmed that the DOI
    # matches the other details for this publication
    doi_confirmed = models.BooleanField(blank=True, default=False)
