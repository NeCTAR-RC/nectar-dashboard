...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'AllocationRequest.tenant_name'
        db.alter_column(u'rcallocation_allocationrequest', 'tenant_name',
    ...
    models = {
        u'rcallocation.allocationrequest': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 7, 4, 0, 0)'}),
