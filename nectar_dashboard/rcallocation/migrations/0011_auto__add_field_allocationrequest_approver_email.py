...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AllocationRequest.approver_email'
        db.add_column('rcallocation_allocationrequest', 'approver_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AllocationRequest.approver_email'
        db.delete_column('rcallocation_allocationrequest', 'approver_email')
    ...
    models = {
        'rcallocation.allocationrequest': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'N'", 'max_length': '1'}),
            'status_explanation': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'submit_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)'}),
