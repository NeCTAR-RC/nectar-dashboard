...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AllocationRequest.status_explaination'
        db.add_column('rcallocation_allocationrequest', 'status_explaination',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AllocationRequest.status_explaination'
        db.delete_column('rcallocation_allocationrequest', 'status_explaination')
    ...
    models = {
        'rcallocation.allocationrequest': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 7, 0, 0)'}),
            ...
            'submit_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 7, 0, 0)'}),
