...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(
            name='grant',
            unique_together=set([('allocation', 'grant_type', 'grant_subtype', 'funding_body_scheme', 'grant_id', 'first_year_funded', 'total_funding')]),
        ),
    ]
