...
def set_unassigned_allocation_home(apps, schema_editor):
    ...
    for allocation in AllocationRequest.objects.filter(requested_allocation_home='national'):
