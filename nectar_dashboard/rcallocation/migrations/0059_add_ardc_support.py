    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enabled', models.BooleanField(default=True, help_text='False hides the program or project', verbose_name='Determines if the user can choose this program or project')),
                ('rank', models.IntegerField(default=100, help_text='Smaller values mean earlier.  Duplicates are OK.', verbose_name='Determines the primary ranking in menus')),
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text='You can use this field to provide extra details for\n        the ARDC project(s) supporting this request.', max_length=1024, verbose_name='ARDC Support details'),
        ),
        migrations.AlterField(
            model_name='allocationrequest',
            name='ncris_explanation',
            field=models.CharField(blank=True, help_text='You can use this field to provide extra details for\n        the NCRIS Facility(s) supporting or supported by this request.', max_length=1024, verbose_name='NCRIS Support details'),
        ),
        migrations.AddField(
            model_name='allocationrequest',
            name='ardc_support',
