    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(help_text='The day when the program or project starts', null=True, verbose_name='Start date')),
                ('end_date', models.DateField(help_text='The day when the program or project ends', null=True, verbose_name='End date')),
