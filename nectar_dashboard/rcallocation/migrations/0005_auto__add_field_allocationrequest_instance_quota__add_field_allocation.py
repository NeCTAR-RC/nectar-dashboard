...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AllocationRequest.instance_quota'
        db.add_column('rcallocation_allocationrequest', 'instance_quota',
                      self.gf('django.db.models.fields.IntegerField')(default='2'),
                      keep_default=False)

        # Adding field 'AllocationRequest.ram_quota'
        db.add_column('rcallocation_allocationrequest', 'ram_quota',
                      self.gf('django.db.models.fields.IntegerField')(default='4'),
                      keep_default=False)

        # Adding field 'AllocationRequest.core_quota'
        db.add_column('rcallocation_allocationrequest', 'core_quota',
                      self.gf('django.db.models.fields.IntegerField')(default='2'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AllocationRequest.instance_quota'
        db.delete_column('rcallocation_allocationrequest', 'instance_quota')

        # Deleting field 'AllocationRequest.ram_quota'
        db.delete_column('rcallocation_allocationrequest', 'ram_quota')

        # Deleting field 'AllocationRequest.core_quota'
        db.delete_column('rcallocation_allocationrequest', 'core_quota')
