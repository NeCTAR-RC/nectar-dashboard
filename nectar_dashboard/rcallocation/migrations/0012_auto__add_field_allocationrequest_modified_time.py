...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AllocationRequest.modified_time'
        db.add_column('rcallocation_allocationrequest', 'modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AllocationRequest.modified_time'
        db.delete_column('rcallocation_allocationrequest', 'modified_time')
