...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'AllocationRequest.status_explaination'
        db.rename_column('rcallocation_allocationrequest', 'status_explaination',
                                                           'status_explanation')


    def backwards(self, orm):
        # Renaming field 'AllocationRequest.status_explaination'
        db.rename_column('rcallocation_allocationrequest', 'status_explanation',
                                                           'status_explaination')
