...
# This is used in the ARDCChoiceField's superclass to transform
# the simple option list into a list optgroups containing options.
# This gives us a choices menu with some structure to it.
#
...
class ARDCSupportChoiceIterator(ModelChoiceIterator):
    ...
    def __iter__(self):
        # Each 'rank' maps to an optgroup.  Within each optgroups,
        # the options are orded in 'short_name' order/
        group = []
        rank = -1
