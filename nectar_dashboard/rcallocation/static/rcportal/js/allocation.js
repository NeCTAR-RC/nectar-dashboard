...
(function($) {
    ...
    function show_allowed_grant_subtypes(type_selector) {
    ...
    $.fn.gformset = function(options) {
        ...
        return this.each(function() {
            ...
            $('div.' + options.formset_class_id).on('change', 'select[name$=-grant_type]', function(event) {
                event.preventDefault();
                var type_selector = $(this);
                show_allowed_grant_subtypes(type_selector);
            });
