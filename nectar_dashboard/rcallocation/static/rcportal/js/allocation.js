...
function init_pub_form_visibility(tr, output_type, transition) {
...
function format_title(msg) {
    return msg['title'] || "Not recorded";
};

function format_publication(msg) {
    return msg['container-title'] || "Not recorded";
};
...
function render_crossref_metadata(json) {
    try {
        ...
        var msg = data.message;
        return "Title: " + format_title(msg) +
            ", Author(s): " + format_authors(msg) +
            ", Publication: " + format_publication(msg) +
